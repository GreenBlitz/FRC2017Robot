 ...
 *
 */
public class TurnDegrees extends Command implements PIDSource,PIDOutput{
	int PIDcounter = 0;
    ...
    public TurnDegrees(double angle, long milliseconds, boolean reset) {
    ...
    public TurnDegrees(double angle, long milliseconds) {
    ...
    public TurnDegrees(double angle, boolean reset){
    	this(angle, -1, reset);
    }
