 ...
 *
 */
public class CollectFuelByDrive extends Command {

	public CollectFuelByDrive() {
	...
	protected void execute() {
		if (Chassis.getInstance().getCurrentCommand() instanceof ArcadeDriveByJoystick){
			
		} else if (Chassis.getInstance().getCurrentCommand() instanceof TankDriveByJoystick){
			if (OI.getInstance().getMainLeftY() > 0 || OI.getInstance().getMainRightY() > 0){
