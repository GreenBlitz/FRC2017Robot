...
public class ThreeCIMShifter {
	...
	private class SpeedRobotDrive extends RobotDrive{
		...
		private double kP = 0, kI = 0.1, kD = 0;
		...
		protected void setLeftRightMotorOutput(double left, double right){
			...
			super.setLeftRightMotorOutputs(m_leftSlave.getValue() / maxRpm, m_rightSlave.getValue() / maxRpm);
		}
